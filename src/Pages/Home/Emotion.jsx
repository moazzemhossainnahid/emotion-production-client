...
const Emotion = () => {
    ...
    return (
        <div className='mt-20 container emotion'>
            <h2 className='text-center'>Why Emotion</h2>
            <div className='max-w-xs m-auto rounded-xl mt-10 p-2 bg-white  flex justify-center items-center'>
                <button>Company</button>
                <button className='ml-10 rounded-full btn btngost'>Owner</button>
            </div>
