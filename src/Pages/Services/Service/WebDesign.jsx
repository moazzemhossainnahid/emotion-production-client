...
const WebDesign = () => {
    ...
    return (
        <div className="container px-7 mx-auto w-full text-white ">
            ...
            <div className='flex flex-col md:flex-row justify-between items-center  mt-10 mb-24'>
                <Bounce bottom>
                    <div className='w-full p-4 space-y-3'>
                        <h2 className='text-center text-2xl sm:text-4xl sm:text-left'> Web Design can make easy your complex product.
                            services</h2>
            ...
            {/*======== Portfulio =============== */}
            <div className='container w-full md:w-5/6 mx-auto grid grid-cols-1 sm:grid-cols-3 place-items-center mb-36 gap-4'>
                <Slide bottom>
