...
//                 <div className='sm:w-[770px] w-full p-0 sm:p-5'>
//                     <h2 className='text-center text-3xl sm:text-6xl sm:text-left'>leading provider of
//                         UI/UX design development
//                         services</h2>
//                     <p className='text-center sm:text-left'>Emotion continues to place a lot of emphasis on UI/UX Design development. For platforms
...
//             <div className='text-style-bottom sm:w-[770px]  p-0 sm:p-5 mt-14'>
